...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
    <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Histori Peminjaman Barang</a>
        <!-- Form -->
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0">Tabel Data Histori Barang Pinjaman</h3>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  @elseif($data->tanggal_kembali < $now)
                                    <font color="red"><strong>Belum Dikembalikan</strong></font>
                                  @elseif($data->tanggal_kembali == $now)
                                    -
                                  @else
                                    -
